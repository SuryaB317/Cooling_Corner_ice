        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <a href="register.php" class="btn btn-light py-md-3 px-md-5 mt-2 rounded-pill">Register</a>
                        </div>
                    </div>
            ...
            <div class="service-item">
                ...
                <div class="service-item p-2">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                ...
                                <a href="register.php" class="border-bottom border-secondary text-decoration-none text-secondary">Learn More</a>
                            </div>
                        </div>
            </div>
        </div>
    ...
    <div class="container py-5 ">
        ...
        <div class="row m-0 portfolio-container ">
            ...
            <div class="col-12 text-center">
                    <a href="register.php" class="btn btn-light py-3 px-5 rounded-pill">Load More &nbsp;
        ...
        <div class="row">
            <div class="col-12">
                <div class="owl-carousel  product-carousel d-flex flex-wrap justify-content-center">
                    ...
                    <div class="col-12 text-center">
                    <a href="register.php" class="btn btn-light py-3 px-5 rounded-pill">Buy Now &nbsp;
