...
<head>
    ...
    <link href="./assets/css/owl.carousel.scss" rel="stylesheet">
    <link href="./assets/js/owl.carousel.js" rel="stylesheet"> -->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="myNavBar">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item active"><a href="user-service.php" class="nav-link">Service</a></li>
            ...
            <div class="service-item">
                ...
                <div class="service-item p-2">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                ...
                                <p>One of the most famous dessart in world wide is known as icecream Dolor kasd lorem duo stet kasd justo</p>
        ...
        <div class="col-md-3">
            <div class="service-item">
                ...
                <div class="service-item p-2">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                <h5 class="font-weight-semi-bold mt-5 mb-3 pt-5">Celebration Cream</h5>
                                <p>One of the most famous dessart in world wide is known as icecream Dolor kasd lorem duo stet kasd justo</p>
                                <a href="" class="border-bottom border-secondary text-decoration-none text-secondary">Learn More</a>
                            </div>
                        </div>
        ...
        <div class="col-md-3">
            <div class="service-item">
                ...
                <div class="service-item p-2">
                            ...
                            <div class="position-relative text-center bg-light rounded p-4 pb-5" style="margin-top: -75px;">
                                <h5 class="font-weight-semi-bold mt-5 mb-3 pt-5">Good in Quality</h5>
                                <p>One of the most famous dessart in world wide is known as icecream Dolor kasd lorem duo stet kasd justo</p>
                                <a href="" class="border-bottom border-secondary text-decoration-none text-secondary">Learn More</a>
                            </div>
                        </div>
